...
class GPU:
	def __init__(self):
		...
		fname='/sys/devices/gpu.0/devfreq/57000000.gpu/max_freq'
		with open(fname,'w') as f:
			f.write('{}'.format(gpu_clock_list[12]))
			f.close()
		fname='/sys/devices/gpu.0/devfreq/57000000.gpu/min_freq'
		with open(fname,'w') as f:
	...
	def setGPUclock(self,i):
		self.clk=i
		fname='/sys/devices/gpu.0/devfreq/57000000.gpu/userspace/set_freq'
#		fname='/sys/devices/gpu.0/devfreq/57000000.gpu/target_freq'
		f=open(fname,'w')
