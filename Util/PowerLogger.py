...
dir_power1='/sys/kernel/debug/regulator'
class PowerLogger:
	...
	def getCPUpower(self):
		fname='{}/6-0040/iio:device0/in_power1_input'.format(dir_power)
	...
	def getCPUvoltage(self):
		fname='{}/6-0040/iio:device0/in_voltage1_input'.format(dir_power)
		with open(fname,'r') as f:
			line=f.readline()
			line.replace('\n','')
			line.replace('\n','')
	...
	def getCPUvoltage1(self):
		fname="/sys/kernel/debug/regulator/rail_voltages"
		with open(fname,'r') as f:
			for line in f:
                # Match the line containing "vdd-cpu" and extract the voltage
				if "vdd-cpu" in line:
					# Extract the voltage value from the line
					parts = line.split(":")
					voltage_part = parts[1].strip()  # Get the part after the colon
					vdd_cpu_voltage = int(voltage_part.split(" ")[0])  # Extract the number
					return vdd_cpu_voltage / 1000

	def getCPUmaxvoltage(self):
		fname='{}/vdd-cpu/dvfs-vdd-cpu/max_uV'.format(dir_power1)
		with open(fname,'r') as f:
			line=f.readline()
			line.replace('\n','')
			f.close()
	...
	def getCPUminvoltage(self):
		fname='{}/vdd-cpu/dvfs-vdd-cpu/min_uV'.format(dir_power1)
		with open(fname,'r') as f:
			line=f.readline()
			line.replace('\n','')
			return int(line)/1000
	...
	def getCPUcurrent(self):
		fname='{}/6-0040/iio:device0/in_current1_input'.format(dir_power)
		with open(fname,'r') as f:
			line=f.readline()
			line.replace('\n','')
			line.replace('\n','')
	...
	def getGPUpower(self):
		fname='{}/6-0040/iio:device0/in_power0_input'.format(dir_power)
		with open(fname,'r') as f:
			line=f.readline()
			line.replace('\n','')
			f.close()
	...
	def getGPUvoltage(self):
		fname='{}/6-0040/iio:device0/in_voltage0_input'.format(dir_power)
		with open(fname,'r') as f:
			line=f.readline()
			line.replace('\n','')
			f.close()
		...
		with open(fname,'r') as f:
			for line in f:
				if "vdd-gpu" in line:
					...
					parts = line.split(":")
					voltage_part = parts[1].strip()  # Get the part after the colon
					vdd_gpu_voltage = int(voltage_part.split(" ")[0])  # Extract the number
					return vdd_gpu_voltage / 1000
	def getGPUmaxvoltage(self):
		fname='{}/vdd-gpu/dvfs-vdd-gpu/max_uV'.format(dir_power1)
		with open(fname,'r') as f:
			line=f.readline()
			line.replace('\n','')
			f.close()
	...
	def getGPUminvoltage(self):
		fname='{}/vdd-gpu/dvfs-vdd-gpu/min_uV'.format(dir_power1)
		with open(fname,'r') as f:
			line=f.readline()
			line.replace('\n','')
			return int(line)/1000
	def getGPUcurrent(self):
		fname='{}/6-0040/iio:device0/in_current0_input'.format(dir_power)
		with open(fname,'r') as f:
			line=f.readline()
			line.replace('\n','')
			f.close()
	...
	def getDDRpower(self):
		fname='{}/6-0040/iio:device0/in_power2_input'.format(dir_power)
		with open(fname,'r') as f:
			line=f.readline()
			line.replace('\n','')
			f.close()
